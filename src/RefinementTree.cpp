...
//            nodes[shigh]._correction[dimen] = nodes[slow]._correction[dimen];
            ...
            nodes[slow]._dev = std::sqrt(nodes[org]._predictor._data[svar]._lowq._variance)*1.0;
            nodes[shigh]._dev = std::sqrt(nodes[org]._predictor._data[svar]._highq._variance)*1.0;
