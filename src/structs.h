...
{   
    ...
    double _variance = 0;
    auto& avg() { return _avg; }
    auto& cnt() { return _cnt; }
    auto& avg() const { return _avg; }
    auto& cnt() const { return _cnt; }
...
struct splitfilter_t {
    ...
    double _hfilter = 0.0;
    double _lfilter = 0.0;
    void reset() { _vfilter = _hfilter = _lfilter = 0;}
    double max() const { return std::max(_vfilter, std::max(_hfilter, _lfilter)); }
